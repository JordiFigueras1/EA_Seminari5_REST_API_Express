...
router.post('/linkExperience/:userId/:experienceId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield userServices.getEntries.linkExperience(req.params.userId, req.params.experienceId);
...
router.delete('/unlinkExperience/:userId/:experienceId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield userServices.getEntries.unlinkExperience(req.params.userId, req.params.experienceId);
