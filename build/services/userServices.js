...
exports.getEntries = {
    ...
    linkExperience: (userId, experienceId) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_users_1.usersofDB.findByIdAndUpdate(userId, { $addToSet: { experiencies: experienceId } }, { new: true });
    }),
    unlinkExperience: (userId, experienceId) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_users_1.usersofDB.findByIdAndUpdate(userId, { $pull: { experiencies: experienceId } }, { new: true });
    }),
